...
const EXERCISES = [
  ...
  { id: 'pushup', name: 'Push-Ups', muscle: 'chest', secondary: ['triceps', 'shoulders', 'core'],
  ...
  { id: 'pushup-wide', name: 'Wide Push-Ups', muscle: 'chest', secondary: ['shoulders'],
  ...
  // ===== BACK =====
  { id: 'pullup', name: 'Pull-Ups', muscle: 'back', secondary: ['biceps'],
  ...
  { id: 'chin-up', name: 'Chin-Ups', muscle: 'back', secondary: ['biceps'],
  ...
  { id: 'inv-row', name: 'Inverted Rows', muscle: 'back', secondary: ['biceps'],
  ...
  { id: 'bw-squat', name: 'Bodyweight Squat', muscle: 'legs', secondary: ['core'],
  ...
  { id: 'bw-lunges', name: 'Bodyweight Lunges', muscle: 'legs', secondary: ['core'],
  ...
  { id: 'glute-bridge', name: 'Glute Bridge', muscle: 'legs', secondary: ['core'],
  ...
  { id: 'pike-pushup', name: 'Pike Push-Ups', muscle: 'shoulders', secondary: ['triceps'],
  ...
  { id: 'dips', name: 'Parallel Bar Dips', muscle: 'triceps', secondary: ['chest', 'shoulders'],
  ...
  { id: 'bench-dips', name: 'Bench Dips', muscle: 'triceps', secondary: ['shoulders'],
  ...
  { id: 'diamond-pushup', name: 'Diamond Push-Ups', muscle: 'triceps', secondary: ['chest'],
  ...
  { id: 'mountain-climb', name: 'Mountain Climbers', muscle: 'core', secondary: ['legs'],
...
function renderOnboarding() {
  ...
  const steps = [
    ...
    // Шаг 3: оборудование (детальный список)
    {
      ...
      multi: true,
      options: [
        { id: 'dumbbells', icon: '🏋️', name: 'Dumbbells', desc: 'Adjustable or fixed' },
        { id: 'barbell', icon: '🏋️‍♂️', name: 'Barbell', desc: 'Bar + plates' },
        { id: 'bench', icon: '🛋️', name: 'Bench', desc: 'Flat bench' },
        { id: 'bench-incline', icon: '📐', name: 'Incline bench', desc: 'Adjustable angle' },
        { id: 'pullup-bar', icon: '🔝', name: 'Pull-up bar', desc: 'Home or outdoor' },
        { id: 'parallel-bars', icon: '🅿️', name: 'Parallel bars', desc: 'For dips' },
        { id: 'bands', icon: '🎗️', name: 'Bands', desc: 'Resistance bands' },
        { id: 'kettlebell', icon: '🔔', name: 'Kettlebell', desc: 'Any weight' }
      ],
      field: 'equipment',
...
function workoutSilhouetteSVG(muscles) {
  ...
  return `
    <div style="display:flex;justify-content:center;align-items:flex-start;gap:24px;padding:8px 0;">
      <!-- ВИД СПЕРЕДИ -->
      <svg viewBox="0 0 80 180" width="90" height="200" xmlns="http://www.w3.org/2000/svg">
        <!-- голова -->
        <circle cx="40" cy="14" r="9" fill="${skin}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- шея -->
        <rect x="36" y="22" width="8" height="5" fill="${skin}"/>
        <!-- плечи -->
        <path d="M22 30 Q18 32 16 40 L24 44 L30 36 L30 28 Z" fill="${c('shoulders')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M58 30 Q62 32 64 40 L56 44 L50 36 L50 28 Z" fill="${c('shoulders')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- грудь левая/правая -->
        <path d="M30 30 L40 30 L40 56 L31 58 Q28 50 30 30 Z" fill="${c('chest')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M50 30 L40 30 L40 56 L49 58 Q52 50 50 30 Z" fill="${c('chest')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- бицепсы -->
        <path d="M16 40 L13 64 L21 67 L24 44 Z" fill="${c('biceps')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M64 40 L67 64 L59 67 L56 44 Z" fill="${c('biceps')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- предплечья -->
        <rect x="11" y="65" width="9" height="22" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <rect x="60" y="65" width="9" height="22" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <!-- пресс -->
        <path d="M31 58 L49 58 L48 86 L32 86 Z" fill="${c('core')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- линии пресса (только если активен) -->
        ${set.has('core') ? `
          <line x1="40" y1="60" x2="40" y2="84" stroke="rgba(0,0,0,0.35)" stroke-width="0.8"/>
          <line x1="33" y1="68" x2="47" y2="68" stroke="rgba(0,0,0,0.35)" stroke-width="0.8"/>
          <line x1="33" y1="76" x2="47" y2="76" stroke="rgba(0,0,0,0.35)" stroke-width="0.8"/>
        ` : ''}
        <!-- бёдра/ноги -->
        <path d="M32 86 L30 130 L38 132 L40 86 Z" fill="${c('legs')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M48 86 L50 130 L42 132 L40 86 Z" fill="${c('legs')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- голени -->
        <rect x="30" y="132" width="9" height="36" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <rect x="41" y="132" width="9" height="36" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
      </svg>
      ...
      <svg viewBox="0 0 80 180" width="90" height="200" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- шея -->
        <rect x="36" y="22" width="8" height="5" fill="${skin}"/>
        <!-- трапеция/плечи сзади -->
        <path d="M22 30 Q18 32 16 40 L24 44 L30 36 L30 28 Z" fill="${c('shoulders')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M58 30 Q62 32 64 40 L56 44 L50 36 L50 28 Z" fill="${c('shoulders')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- спина (вся область) -->
        <path d="M30 30 L50 30 L51 70 L29 70 Z" fill="${c('back')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- центральная линия позвоночника -->
        ${set.has('back') ? `<line x1="40" y1="32" x2="40" y2="68" stroke="rgba(0,0,0,0.35)" stroke-width="0.8"/>` : ''}
        <!-- трицепсы -->
        <path d="M16 40 L13 64 L21 67 L24 44 Z" fill="${c('triceps')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M64 40 L67 64 L59 67 L56 44 Z" fill="${c('triceps')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- предплечья -->
        <rect x="11" y="65" width="9" height="22" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <rect x="60" y="65" width="9" height="22" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <!-- ягодицы / низ спины -->
        <path d="M29 70 L51 70 L49 88 L31 88 Z" fill="${c('legs')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- задняя поверхность бедра -->
        <path d="M32 88 L30 130 L38 132 L40 88 Z" fill="${c('legs')}" stroke="${stroke}" stroke-width="0.8"/>
        <path d="M48 88 L50 130 L42 132 L40 88 Z" fill="${c('legs')}" stroke="${stroke}" stroke-width="0.8"/>
        <!-- голени -->
        <rect x="30" y="132" width="9" height="36" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
        <rect x="41" y="132" width="9" height="36" rx="3" fill="${skin}" stroke="${stroke}" stroke-width="0.6"/>
      </svg>
...
function showWorkoutDetails(date) {
  ...
  const duration = w.duration ? Math.round(w.duration / 60) + 'm' : '';
...
function drawWorkoutSilhouette(ctx, muscles, cx, ty, h, COLORS) {
  ...
  const drawFigure = (originX, isFront) => {
    ...
    // Плечи (одинаково на front/back)
    drawShape(c('shoulders'), () => {
      ctx.moveTo(sx(22), sy(30));
      ctx.quadraticCurveTo(sx(18), sy(32), sx(16), sy(40));
      ctx.lineTo(sx(24), sy(44));
      ctx.lineTo(sx(30), sy(36));
      ctx.lineTo(sx(30), sy(28));
    });
    drawShape(c('shoulders'), () => {
      ctx.moveTo(sx(58), sy(30));
      ctx.quadraticCurveTo(sx(62), sy(32), sx(64), sy(40));
    ...
    if (isFront) {
      ...
      drawShape(c('chest'), () => {
        ...
        ctx.lineTo(sx(40), sy(56));
        ctx.lineTo(sx(31), sy(58));
        ctx.quadraticCurveTo(sx(28), sy(50), sx(30), sy(30));
      });
      // Грудь правая
      drawShape(c('chest'), () => {
        ...
        ctx.lineTo(sx(40), sy(30));
        ctx.lineTo(sx(40), sy(56));
        ctx.lineTo(sx(49), sy(58));
        ctx.quadraticCurveTo(sx(52), sy(50), sx(50), sy(30));
      });
      // Бицепсы
      drawShape(c('biceps'), () => {
        ctx.moveTo(sx(16), sy(40));
        ctx.lineTo(sx(13), sy(64));
        ctx.lineTo(sx(21), sy(67));
        ctx.lineTo(sx(24), sy(44));
      });
      drawShape(c('biceps'), () => {
        ctx.moveTo(sx(64), sy(40));
        ctx.lineTo(sx(67), sy(64));
        ctx.lineTo(sx(59), sy(67));
        ctx.lineTo(sx(56), sy(44));
      });
      // Пресс
      drawShape(c('core'), () => {
        ctx.moveTo(sx(31), sy(58));
        ctx.lineTo(sx(49), sy(58));
        ctx.lineTo(sx(48), sy(86));
        ctx.lineTo(sx(32), sy(86));
      });
      // Линии пресса (только если активен)
      if (set.has('core')) {
        ...
        ctx.lineWidth = 1.5;
        ctx.beginPath();
        ctx.moveTo(sx(40), sy(60)); ctx.lineTo(sx(40), sy(84));
        ctx.moveTo(sx(33), sy(68)); ctx.lineTo(sx(47), sy(68));
        ctx.moveTo(sx(33), sy(76)); ctx.lineTo(sx(47), sy(76));
        ctx.stroke();
        ctx.strokeStyle = COLORS.borderStrong;
        ctx.lineWidth = 1.5;
      }
      // Бёдра/квадрицепсы
      drawShape(c('legs'), () => {
        ctx.moveTo(sx(32), sy(86));
        ctx.lineTo(sx(30), sy(130));
        ctx.lineTo(sx(38), sy(132));
        ctx.lineTo(sx(40), sy(86));
      });
      drawShape(c('legs'), () => {
        ctx.moveTo(sx(48), sy(86));
        ctx.lineTo(sx(50), sy(130));
        ctx.lineTo(sx(42), sy(132));
        ctx.lineTo(sx(40), sy(86));
      });
    } else {
      // СПИНА — единый блок
      ...
      // Линия позвоночника если активен
      if (set.has('back')) {
        ctx.strokeStyle = 'rgba(0,0,0,0.45)';
        ctx.lineWidth = 1.5;
        ctx.beginPath();
        ctx.moveTo(sx(40), sy(32)); ctx.lineTo(sx(40), sy(68));
        ctx.stroke();
        ctx.strokeStyle = COLORS.borderStrong;
        ctx.lineWidth = 1.5;
      }
      ...
      drawShape(c('legs'), () => {
        ...
        ctx.lineTo(sx(51), sy(70));
        ctx.lineTo(sx(49), sy(88));
        ctx.lineTo(sx(31), sy(88));
      });
      // Задняя поверхность бедра
      drawShape(c('legs'), () => {
    ...
    ctx.fillStyle = COLORS.bgElev2;
    roundRect(ctx, sx(11), sy(65), sx(20) - sx(11), sy(87) - sy(65), 4);
    ctx.fill();
    ctx.stroke();
    roundRect(ctx, sx(60), sy(65), sx(69) - sx(60), sy(87) - sy(65), 4);
    ctx.fill();
    ctx.stroke();

    // Голени
    ctx.fillStyle = COLORS.bgElev2;
    roundRect(ctx, sx(30), sy(132), sx(39) - sx(30), sy(168) - sy(132), 4);
    ctx.fill();
    ctx.stroke();
    roundRect(ctx, sx(41), sy(132), sx(50) - sx(41), sy(168) - sy(132), 4);
    ctx.fill();
    ctx.stroke();
  };
